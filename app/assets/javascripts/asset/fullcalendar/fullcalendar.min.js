...
var Popover = Class.extend(ListenerMixin, {
	...
	// Triggered when the contact clicks *anywhere* in the document, for the autoHide feature
...
var CoordCache = FC.CoordCache = Class.extend({
	...
	// Compute and return what the elements' bounding rectangle is, from the contact's perspective.
...
DragListener.mixin({
	...
	// Called when scrolling has stopped, whether through auto scroll, or the contact scrolling
...
var HitDragListener = DragListener.extend({
	...
	handleScrollEnd: function() {
		...
		// hits' absolute positions will be in new places after a contact's scroll.
...
/*
Listens to document and window-level contact-interaction events, like touch events and mouse events,
...
var MouseFollower = Class.extend(ListenerMixin, {
	...
	// Gets called when the contact moves the mouse
	handleMove: function(ev) {
...
var Grid = FC.Grid = Class.extend(ListenerMixin, {
	...
	hasDayInteractions: true, // can contact click/select ranges of time?
	...
	// Creates a listener that tracks the contact's drag across day elements, for day clicking.
	buildDayClickListener: function() {
		...
		var dragListener = new HitDragListener(this, {
			...
			hitOver: function(hit, isOrig, origHit) {
				// if contact dragged to another cell at any point, it can no longer be a dayClick
				if (!isOrig) {
					dayClickHit = null;
				}
			},
	...
	// Creates a listener that tracks the contact's drag across day elements, for day selecting.
	...
	// Will return false if the selection is invalid and this should be indicated to the contact.
...
Grid.mixin({
	...
	mousedOverSeg: null, // the segment object the contact's mouse is over. null if over nothing
	...
	unrenderEvents: function() {
		this.handleSegMouseout(); // trigger an eventMouseout if contact's mouse is over an event
		this.clearDragListeners();
	...
	// Executes a handler for any a contact-interaction on a segment.
	...
	// Builds a listener that will track contact-dragging on an event segment.
	...
	// Creates a listener that tracks the contact as they resize an event segment.
	// Generic enough to work with any type of Grid.
...
DayGrid.mixin({
	...
	showSegPopover: function(row, col, moreLink, segs) {
		...
		options = {
			...
			autoHide: true, // when the contact clicks elsewhere, hide the popover
...
var View = FC.View = Model.extend({
	...
	isRTL: false,
	isSelected: false, // boolean whether a range of time is contact-selected or not
	selectedEvent: null,
	...
	// Computes if the given event is allowed to be dragged by the contact
	...
	// Computes if the given event is allowed to be resized by the contact at all
...
Calendar.mixin({
	...
	// TODO: maintain any other contact-manipulated state.
	reinitView: function() {
		this.ignoreWindowResize++;
...
var AgendaView = FC.AgendaView = View.extend({
	...
	// Computes the initial pre-configured scroll state prior to allowing the contact to change it
	computeInitialDateScroll: function() {
...
/*
Responsible for event rendering and contact-interaction.
